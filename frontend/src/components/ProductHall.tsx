            ...
            >
              ...
              <div className="relative h-32 md:h-48 bg-silver-100 dark-mode:bg-black/30 overflow-hidden product-image-wrapper">
                <img
                  ...
                  alt={product.name}
                  className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500 ease-out relative z-0 product-image"
                  onError={(e) => {
                ...
                <div className="flex items-start justify-between mb-2 md:mb-3">
                  ...
                  <button
                    onClick={(e) => {
                      e.preventDefault()
                      e.stopPropagation()
                      window.open('https://wa.me/8617764065981', '_blank', 'noopener,noreferrer')
                    }}
