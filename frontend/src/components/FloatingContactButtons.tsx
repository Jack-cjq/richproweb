  ...
  return (
    ...
    >
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="floating-btn group relative bg-[#1877F2] rounded-full shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center hover:scale-110 active:scale-95 floating-contact-btn"
        aria-label="访问 Facebook"
      >
        {/* Facebook 图标 SVG */}
        <svg
          className="text-white floating-contact-icon"
